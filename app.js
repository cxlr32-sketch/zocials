...
app.post('/api/bank/click', (req, res) => { const b = DB.bank[req.body.username]; b.balance += b.clickLevel; b.history.push({ type: 'клик', amount: b.clickLevel, time: new Date().toLocaleTimeString() }); res.json({ balance: b.balance }); });
